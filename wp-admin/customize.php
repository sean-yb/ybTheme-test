...
if (wp_is_mobile()) :
    ...
    <meta name="viewport" id="viewport-meta"
          content="width=device-width, initial-scale=0.8, minimum-scale=0.5, maximum-scale=1.2"><?php
endif;
    ...
    <form id="customize-controls" class="wrap wp-full-overlay-sidebar">
        ...
        <div class="wp-full-overlay-sidebar-content accordion-container" tabindex="-1">
            <div id="customize-info" class="accordion-section <?php if ($cannot_expand) echo ' cannot-expand'; ?>">
                <div class="accordion-section-title" aria-label="<?php esc_attr_e('Theme Customizer Options'); ?>"
                     tabindex="0">
                ...
                <?php if (!$cannot_expand) : ?>
                    <div class="accordion-section-content">
                        ...
                        <?php if ($wp_customize->theme()->get('Description')): ?>
                            <div
                                class="theme-description"><?php echo $wp_customize->theme()->display('Description'); ?></div>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
            </div>
