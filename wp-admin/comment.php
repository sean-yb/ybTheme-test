            ...
            <div class="narrow">
                ...
                <table class="form-table comment-ays">
                    ...
                    <?php if ($comment->comment_author_url) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo $comment->comment_author_url; ?>"><?php echo $comment->comment_author_url; ?></a>
                            </td>
                        </tr>
                    <?php } ?>
                    <tr>
                        <th scope="row" valign="top"><?php /* translators: field name in comment form */
                            _ex('Comment', 'noun'); ?></th>
                ...
                <form action='comment.php' method='get'>
                    ...
                    <table width="100%">
                        <tr>
                            <td><a class="button"
                                   href="<?php echo admin_url('edit-comments.php'); ?>"><?php esc_attr_e('No'); ?></a>
                            </td>
