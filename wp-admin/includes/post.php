                    ...
                    <p>
                        ...
                        if ($override) {
                            ...
                            <a class="button button-primary wp-tab-last"
                               href="<?php echo esc_url(add_query_arg('get-post-lock', '1', get_edit_post_link($post->ID, 'url'))); ?>"><?php _e('Take over'); ?></a>
                        <?php
                        }
            ...
            <?php
                ...
                <div class="post-taken-over">
                    ...
                    <p class="wp-tab-first" tabindex="0">
                        ...
                        <span class="locked-saving hidden"><img src="images/wpspin_light-2x.gif" width="16"
                                                                height="16"/> <?php _e('Saving revision...'); ?></span>
                        <span
