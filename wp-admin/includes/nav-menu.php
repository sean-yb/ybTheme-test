        ...
        <p id="menu-item-name-wrap">
            <label class="howto" for="custom-menu-item-name">
                ...
                <input id="custom-menu-item-name"
                       name="menu-item[<?php echo $_nav_menu_placeholder; ?>][menu-item-title]" type="text"
                       class="regular-text menu-item-textbox input-with-default-title"
                       title="<?php esc_attr_e('Menu Item'); ?>"/>
            </label>
        </p>
    ...
    <div id="posttype-<?php echo $post_type_name; ?>" class="posttypediv">
        ...
        ?>" id="tabs-panel-posttype-<?php echo $post_type_name; ?>-search">
            ...
            <p class="quick-search-wrap">
                <input type="search" class="quick-search input-with-default-title"
