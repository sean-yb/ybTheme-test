        ...
        <ul>
            ...
            if ($num_comm && $num_comm->total_comments) {
                ...
                if ($num_comm->moderated) {
                    ...
                    ?>
                    <li class="comment-mod-count"><a
                            href="edit-comments.php?comment_status=moderated"><?php echo $text; ?></a></li>
                <?php
                }
            }
...
function wp_dashboard_quick_press($error_msg = false)
{
    ...
    <form name="post" action="<?php echo esc_url(admin_url('post.php')); ?>" method="post" id="quick-press"
        ...
        <div class="input-text-wrap" id="title-wrap">
            <label class="screen-reader-text prompt" for="title"
                   id="title-prompt-text"><?php echo apply_filters('enter_title_here', __('Title'), $post); ?></label>
...
function _wp_dashboard_recent_comments_row(&$comment, $show_date = true)
{
    ...
    <h4 class="comment-meta">
        <?php printf( /* translators: 1: comment author, 2: post link, 3: notification if the comment is pending */
