...
?>
    ...
    <span
        class="max-upload-size"><?php printf(__('Maximum upload file size: %d%s.'), esc_html($upload_size_unit), esc_html($sizes[$u])); ?></span>
    <?php
    if (($is_IE || $is_opera) && $max_upload_size > 100 * 1024 * 1024) {
        ?>
        <span
            class="big-file-warning"><?php _e('Your browser has some limitations uploading large files with the multi-file uploader. Please use the browser uploader for files over 100MB.'); ?></span>
    <?php
    }
...
function edit_form_image_editor($post)
{
    ...
    <div class="wp_attachment_holder">
        ...
        if (wp_attachment_is_image($post->ID)) :
            ...
            <div<?php if ($open) echo ' style="display:none"'; ?> class="wp_attachment_image"
...
function attachment_submitbox_metadata()
{
    ...
    <div class="misc-pub-section misc-pub-attachment">
        ...
        <input type="text" class="widefat urlfield" readonly="readonly" name="attachment_url"
