    ...
    <h2><?php esc_html_e('Themes'); ?>
        ...
        <?php if (!is_multisite() && current_user_can('install_themes')) : ?>
            <a href="<?php echo admin_url('theme-install.php'); ?>"
               class="add-new-h2"><?php echo esc_html(_x('Add New', 'Add new theme')); ?></a>
        <?php endif; ?>
    </h2>
    <?php
    ...
    elseif (isset($_GET['activated'])) :
        if (isset($_GET['previewed'])) {
            ...
            <div id="message2" class="updated">
                <p><?php printf(__('Settings saved and theme activated. <a href="%s">Visit site</a>'), home_url('/')); ?></p>
            </div>
        <?php } else { ?>
            <div id="message2" class="updated">
            <p><?php printf(__('New theme activated. <a href="%s">Visit site</a>'), home_url('/')); ?></p></div><?php
        }
        ...
        <div class="themes">
            ...
            foreach ($themes as $theme) : ?>
                <div class="theme<?php if ($theme['active']) echo ' active'; ?>">
                    ...
                    <?php if ($theme['active']) { ?>
                        <h3 class="theme-name">
                            <span><?php _ex('Active:', 'theme'); ?></span> <?php echo $theme['name']; ?></h3>
                    <?php } else { ?>
                    ...
                    <div class="theme-actions">
                        ...
                        <?php } else { ?>
                            ...
                            <a class="button button-secondary load-customize hide-if-no-customize"
                               href="<?php echo $theme['actions']['customize']; ?>"><?php _e('Live Preview'); ?></a>
                            <a class="button button-secondary hide-if-customize"
                               href="<?php echo $theme['actions']['preview']; ?>"><?php _e('Preview'); ?></a>
                        <?php } ?>
                                    ...
                                    <# if ( data.actions.customize ) { #>
                                        ...
                                        <# } #>
                                            <# } else { #>
                                                ...
                                                <a class="button button-secondary hide-if-customize"
                                                   href="{{{ data.actions.preview }}}"><?php _e( 'Preview' ); ?></a>
                                                <# } #>
        ...
        <div class="theme-about">
            ...
            <div class="theme-info">
                <# if ( data.active ) { #>
                    ...
                    <# } #>
                        <h3 class="theme-name">{{{ data.name }}}<span
            ...
            <div class="inactive-theme">
                <# if ( data.actions.activate ) { #>
                    <a href="{{{ data.actions.activate }}}"
                       class="button button-primary activate"><?php _e( 'Activate' ); ?></a>
                    <# } #>
                        <a href="{{{ data.actions.customize }}}"
                           class="button button-secondary load-customize hide-if-no-customize"><?php _e( 'Live Preview' ); ?></a>
                        <a href="{{{ data.actions.preview }}}"
                           class="button button-secondary hide-if-customize"><?php _e( 'Preview' ); ?></a>
            </div>
