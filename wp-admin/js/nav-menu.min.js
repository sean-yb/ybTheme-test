    ...
    b = wpNavMenu = {options: {menuItemDepthPerLevel: 30, globalMaxDepth: 11}, menuList: void 0, targetList: void 0, menusChanged: !1, isRTL: !("undefined" == typeof isRtl || !isRtl), negateIfRTL: "undefined" != typeof isRtl && isRtl ? -1 : 1, init: function () {
        ...
        a.fn.extend({menuItemDepth: function () {
            ...
            return 0 === a("#menu-to-edit").length ? !1 : this.each(function () {
                var d = a(this), e = {}, f = menus.oneThemeLocationNoMenus && 0 === d.find(".tabs-panel-active .categorychecklist li input:checked").length ? d.find('#page-all li input[type="checkbox"]') : d.find(".tabs-panel-active .categorychecklist li input:checked"), g = /menu-item\[([^\]]*)/;
        ...
        a(".item-edit").off("focus").on("focus", function () {
            a(this).off("keydown").on("keydown", function (c) {
                ...
                if ((37 == c.which || 38 == c.which || 39 == c.which || 40 == c.which) && (e.off("keydown"), 1 !== a("#menu-to-edit li").length)) {
                    switch (d = {38: "up", 40: "down", 37: "left", 39: "right"}, a("body").hasClass("rtl") && (d = {38: "up", 40: "down", 39: "left", 37: "right"}), d[c.which]) {
                        case"up":
                            b.moveMenuItem(e, "up");
                            break;
                        case"down":
        ...
        postboxes.add_postbox_toggles("nav-menus"), columns.useCheckboxesForHidden(), columns.checked = function (b) {
            ...
            a.post(ajaxurl, {action: "closed-postboxes", hidden: b, closedpostboxesnonce: jQuery("#closedpostboxesnonce").val(), page: "nav-menus"})
        })
        ...
        0 !== a("#menu-to-edit li").length && a(".drag-instructions").show(), r += b.isRTL ? b.menuList.width() : 0, b.menuList.sortable({handle: ".menu-item-handle", placeholder: "sortable-placeholder", start: function (e, f) {
            var h, i, j, k, l;
        ...
        a(".quick-search").keypress(function (d) {
            var e = a(this);
            return 13 == d.which ? (b.updateQuickSearchResults(e), !1) : (c && clearTimeout(c), c = setTimeout(function () {
                b.updateQuickSearchResults(e)
            }, 400), void 0)
        }).attr("autocomplete", "off")
    }, updateQuickSearchResults: function (c) {
        var d, e, f = 2, g = c.val();
        g.length < f || (d = c.parents(".tabs-panel"), e = {action: "menu-quick-search", "response-format": "markup", menu: a("#menu").val(), "menu-settings-column-nonce": a("#menu-settings-column-nonce").val(), q: g, type: c.attr("name")}, a(".spinner", d).show(), a.post(ajaxurl, e, function (a) {
        ...
        return c = c || b.addMenuItemToBottom, "" === d || "http://" == d ? !1 : (a(".customlinkdiv .spinner").show(), this.addLinkToMenu(d, e, c, function () {
        ...
        }, e = {action: "add-menu-item", menu: f, "menu-settings-column-nonce": g, "menu-item": b}, a.post(ajaxurl, e, function (b) {
        ...
        }), a(".categorychecklist", d).html(k), a(".spinner", d).hide(), void 0) : (a(".categorychecklist", d).html("<li><p>" + navMenuL10n.noResultsFound + "</p></li>"), a(".spinner", d).hide(), void 0)
