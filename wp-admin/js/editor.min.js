window.switchEditors = {switchto: function (a) {
    var b = a.id, c = b.length, d = b.substr(0, c - 5), e = b.substr(c - 4);
    this.go(d, e)
}, go: function (a, b) {
    var c, d, e, f = this, g = tinymce.DOM;
    if (a = a || "content", b = b || "toggle", c = tinymce.get(a), d = "wp-" + a + "-wrap", e = g.get(a), "toggle" === b && (b = c && !c.isHidden() ? "html" : "tmce"), "tmce" === b || "tinymce" === b) {
        if (c && !c.isHidden())return!1;
        "undefined" != typeof QTags && QTags.closeAllTags(a), tinyMCEPreInit.mceInit[a] && tinyMCEPreInit.mceInit[a].wpautop && (e.value = f.wpautop(e.value)), c ? c.show() : (c = new tinymce.Editor(a, tinyMCEPreInit.mceInit[a]), c.render()), g.removeClass(d, "html-active"), g.addClass(d, "tmce-active"), setUserSetting("editor", "tinymce")
    } else if ("html" === b) {
        if (c && c.isHidden())return!1;
        c ? c.hide() : (tinyMCEPreInit.mceInit[a] && tinyMCEPreInit.mceInit[a].wpautop && (e.value = f.pre_wpautop(e.value)), g.setStyles(e, {display: "", visibility: ""})), g.removeClass(d, "tmce-active"), g.addClass(d, "html-active"), setUserSetting("editor", "html")
    }
    return!1
}, _wp_Nop: function (a) {
    var b, c, d = !1, e = !1;
    ...
    var b = !1, c = !1, d = "table|thead|tfoot|caption|col|colgroup|tbody|tr|td|th|div|dl|dd|dt|ul|ol|li|pre|select|option|form|map|area|blockquote|address|math|style|p|h[1-6]|hr|fieldset|noscript|legend|section|article|aside|hgroup|header|footer|nav|figure|figcaption|details|menu|summary";
