...
<div class="wrap">
    ...
    <form method="post" action="options.php">
            ...
            <tr valign="top">
                ...
                <td>
                    <fieldset>
                        ...
                        <label for="use_balanceTags"><input name="use_balanceTags" type="checkbox" id="use_balanceTags"
        ...
        <p class="pressthis"><a onclick="return false;"
        ...
        if (apply_filters('enable_update_services_configuration', true)) {
            ...
            <?php if (1 == get_option('blog_public')) : ?>
                ...
                <p><label
                        for="ping_sites"><?php _e('When you publish a new post, WordPress automatically notifies the following site update services. For more about this, see <a href="http://codex.wordpress.org/Update_Services">Update Services</a> on the Codex. Separate multiple service <abbr title="Universal Resource Locator">URL</abbr>s with line breaks.') ?></label>
                </p>
