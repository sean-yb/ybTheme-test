...
function wp_print_media_templates()
{
    ...
    <script type="text/html" id="tmpl-media-modal">
        <div class="<?php echo $class; ?>">
            <a class="media-modal-close" href="#" title="<?php esc_attr_e('Close'); ?>"><span
                ...
                <# if ( 'image' === data.type && ! data.uploading ) { #>
                    <# if ( data.width && data.height ) { #>
                        ...
                        <# } #>
                            ...
                            <# if ( data.can.save ) { #>
                                <a class="edit-attachment" href="{{ data.editLink }}&amp;image-editor"
                                ...
                                <# } #>
                                    <# } #>
                                        ...
                                        <# if ( data.fileLength ) { #>
                                            <div class="file-length"><?php _e( 'Length:' ); ?> {{ data.fileLength }}
                                            </div>
                                            <# } #>

                                                <# if ( ! data.uploading && data.can.remove ) { #>
                                                    <a class="delete-attachment"
                                                       href="#"><?php _e( 'Delete Permanently' ); ?></a>
                                                    <# } #>
                ...
                <# if ( 'undefined' !== typeof data.sizes ) { #>
					...
					foreach ( $sizes as $value => $name ) : ?>
                                ...
                                <#
                                    ...
                                    if ( size ) { #>
                                    <option
                                        value="<?php echo esc_attr( $value ); ?>" <?php selected( $value, 'full' ); ?>>
