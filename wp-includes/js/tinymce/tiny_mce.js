(function (e) {
    ...
    var c = {majorVersion: "3", minorVersion: "5.9", releaseDate: "2013-10-18", _init: function () {
...
tinymce.util.Quirks = function (a) {
    ...
    function r() {
        function M(P) {
            ...
            O.appendChild(Q);
            return m.serializer.serialize(O, {format: "html"})
        }
    ...
    function v() {
        ...
        B("enableObjectResizing", false);
        ab = {n: [0.5, 0, 0, -1], e: [1, 0.5, 1, 0], s: [0.5, 1, 0, 1], w: [0, 0.5, -1, 0], nw: [0, 0, -1, -1], ne: [1, 0, 1, -1], se: [1, 1, 1, 1], sw: [0, 1, -1, 1]};
        function S(ai) {
            var ah, ag;
            ah = ai.screenX - ac;
            ag = ai.screenY - aa;
            ...
            e.setStyles(M, {width: X, height: W});
        ...
        function R(aj) {
            ...
            F(ab, function (am, ak) {
                ...
                if (!al) {
                    al = e.add(U.documentElement, "div", {id: "mceResizeHandle" + ak, "class": "mceResizeHandle", style: "cursor:" + ak + "-resize; margin:0; padding:0"});
                ...
                e.setStyles(al, {left: (ai * am[0] + O) - (al.offsetWidth / 2), top: (ag * am[1] + N) - (al.offsetHeight / 2)})
            });
...
(function (d) {
    ...
    d.create("tinymce.dom.Selection", {Selection: function (k, j, i, h) {
        ...
        if (s) {
            h = y.getRng();
            if (h.setStart) {
                h = {startContainer: h.startContainer, startOffset: h.startOffset, endContainer: h.endContainer, endOffset: h.endOffset}
            }
            return{rng: h}
        }
        h = y.getRng();
