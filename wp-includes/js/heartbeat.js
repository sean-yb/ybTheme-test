    ...
    var Heartbeat = function () {
        ...
        function initialize() {
            ...
            $(window).on('blur.wp-heartbeat-focus',function () {
                ...
                settings.winBlurTimer = window.setTimeout(function () {
                    blurred();
                }, 500);
            ...
            $('iframe').each(function (i, frame) {
                ...
                $(frame.contentWindow).on('focus.wp-heartbeat-focus',function () {
                    focused();
                        ...
                        settings.frameBlurTimer = window.setTimeout(function () {
                            blurred();
                        }, 500);
                    });
            });
        ...
        function checkUserActivity() {
            ...
            if (!settings.userActivityEvents) {
                $document.on('mouseover.wp-heartbeat-active keyup.wp-heartbeat-active', function () {
                    userIsActive();
                });
                ...
                $('iframe').each(function (i, frame) {
                    ...
                    $(frame.contentWindow).on('mouseover.wp-heartbeat-active keyup.wp-heartbeat-active', function () {
                        userIsActive();
                    });
                });
